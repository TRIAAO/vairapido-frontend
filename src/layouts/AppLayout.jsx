...
const links = [
  ...
  { label: "Pendências WPP", path: "/whatsapp-pendencias", icon: ShieldAlert, allowedRoles: managementRoles },
      ...
      <aside className="fixed left-0 top-0 z-30 hidden h-screen w-72 flex-col bg-navy text-white lg:flex">
        ...
        <div className="border-t border-white/10 p-5">
          <div className="mb-4 rounded-2xl bg-white/10 p-4">
            ...
            <p className="mt-1 text-xs font-bold text-yellowBrand">{user?.role || "-"}</p>
          </div>
        ...
        <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
          <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-5 lg:px-8">
            <div className="min-w-0">
              <p className="text-xs font-black uppercase tracking-wide text-slate-500">Sistema VaiRápido</p>
              <h2 className="text-2xl font-black text-navy">Painéis operacionais</h2>
            </div>
